...
import com.codelaxy.qwertpoiuy.Models.Captcha;
...
public class CaptchaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getCaptcha() {
        ...
        ProgressDialog dialog = new ProgressDialog(CaptchaActivity.this);
        dialog.setCancelable(false);
        dialog.setMessage("Please wait...");
        dialog.show();

        Call<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse> call = RetrofitClient.getInstance().getApi().getCaptcha(user_id);
        call.enqueue(new Callback<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse>() {
            @Override
            public void onResponse(Call<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse> call, Response<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse> response) {

                dialog.dismiss();
                com.codelaxy.qwertpoiuy.ModelsNew.Captcha captcha = response.body().getCaptcha();
                if (captcha != null) {
            ...
            @Override
            public void onFailure(Call<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse> call, Throwable t) {
    ...
    private void submitCaptcha() {
        ...
        Call<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse> call = RetrofitClient.getInstance().getApi().submitCaptcha(user_id, captcha_id, captcha_text.getText().toString().trim(), str_captcha_type);
        call.enqueue(new Callback<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse>() {
            @Override
            public void onResponse(Call<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse> call, Response<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse> response) {
    ...
    private void skipCaptcha() {
        ...
        Call<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse> call = RetrofitClient.getInstance().getApi().skipCaptcha(user_id);
        call.enqueue(new Callback<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse>() {
            @Override
            public void onResponse(Call<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse> call, Response<com.codelaxy.qwertpoiuy.ModelsNew.CaptchaResponse> response) {
